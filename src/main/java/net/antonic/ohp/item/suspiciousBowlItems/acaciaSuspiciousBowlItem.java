...
public class acaciaSuspiciousBowlItem extends SuspiciousStewItem {
    public acaciaSuspiciousBowlItem(Settings settings) {
        super(settings);
    }


    public static void addEffectToStew(ItemStack acaciaSuspiciousBowlItem, StatusEffect effect, int duration) {
        CompoundTag compoundTag = acaciaSuspiciousBowlItem.getOrCreateTag();
