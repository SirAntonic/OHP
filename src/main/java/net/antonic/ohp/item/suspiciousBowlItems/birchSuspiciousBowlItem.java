...
public class birchSuspiciousBowlItem extends SuspiciousStewItem {
    public birchSuspiciousBowlItem(Settings settings) {
        super(settings);
    }


    public static void addEffectToStew(ItemStack birchSuspiciousBowlItem, StatusEffect effect, int duration) {
        CompoundTag compoundTag = birchSuspiciousBowlItem.getOrCreateTag();
